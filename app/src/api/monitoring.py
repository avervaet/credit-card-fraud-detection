...
class MetricsTracker:
    def __init__(self):
        # Request metrics
        self.request_count = Counter("ml_request_total", "Total ML prediction requests", ["endpoint", "status"])
        ...
        self.prediction_distribution = Counter(
            "ml_prediction_class_total", "Distribution of predictions", ["prediction_class"]
        )
        ...
        # System metrics
        self.model_loading_time = Gauge("ml_model_loading_seconds", "Time taken to load the model")
